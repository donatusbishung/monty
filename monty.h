...
void f_push(stack_t **head, unsigned int myNumber);
void f_pal(stack_t **head, unsigned int myNumber);
void f_pint(stack_t **head, unsigned int myNumber);
int execute_code(char *content, stack_t **head, unsigned int countInt, FILE *file);
...
void f_nop(stack_t **head, unsigned int countInt);
void f_sub(stack_t **head, unsigned int countInt);
void f_div(stack_t **head, unsigned int countInt);
...
void f_rotl(stack_t **head, unsigned int countInt);
...
void f_stack(stack_t **head, unsigned int countInt);
#endif